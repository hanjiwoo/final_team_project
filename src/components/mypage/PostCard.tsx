            ...
            <div className="flex h-[100px] justify-between items-center w-full mt-[8px]">
              ...
              <div className="flex flex-col justify-start gap-[12px]">
                ...
                <div className="text-[14px] font-medium leading-[20px] text-[#5C5C5C]  overflow-ellipsis w-[336px] line-clamp-2">
                  <p className="text-[14px] leading-[20px] text-[#5C5C5C]">{post.content}</p>
                </div>
              </div>
              ...
              <div className="w-[100px] h-[100px] bg-[#F1F1F1] rounded-[8px] max-sm:hidden">
                {post.photos?.[0] ? (
                  ...
                  <Image className="w-full h-full shrink-0" src={mockImage} alt="profile" />
                )}
              </div>
            </div>
          </div>
          ...
          <div className="flex w-full justify-between items-center">
            ...
            <div className="flex items-center gap-[16px]">
              <div className="flex items-center gap-[8px]">
                {post.profile ? (
                  <img src={post.profile} className="w-[14px] h-[14px] shrink-0" alt="사람 이미지" />
                ) : (
                  <Image src={userIcon} alt="profile" className="w-[24px] h-[24px] shrink-0" />
                )}
