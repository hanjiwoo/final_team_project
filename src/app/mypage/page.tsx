    ...
    <div className="flex justify-center items-center w-full my-[60px] px-[20px] max-sm:my-[32px] max-lg:my-[60px]">
      <div className="w-[880px]">
        <div className="gap-[60px]">
          <h1 className="text-[28px] font-semibold text-[#212121] leading-[36px] mb-[60px]">내 정보</h1>
        ...
        <div className="flex justify-between items-center rounded-[12px] border-2 p-[24px] border-[#D6D6D6] mb-[60px]">
          <div className="flex justify-center items-center gap-[12px]">
            {isLogin ? (
              <img src={photoURL} className="w-[60px] h-[60px] rounded-full" alt="흐음" />
            ) : (
              <Image src={profileImage} alt="more" className="w-[60px] h-[60px]" />
            )}
            <span className="text-[20px] leading-[36px] text-[#212121]">모두의 음식점</span>
          </div>
          <div
        ...
        <div>
          <h2 className="mb-[24px] text-[#212121] font-semibold text-[20px]">나의 모음</h2>
          <div className="flex flex-col gap-[16px]">
            <div className="  flex justify-between items-center pt-[12px] pb-[12px]">
              <span className="text-[18px] font-medium leading-[26px] text-[#5c5c5c]">매장</span>
              <Image
                src={rightIcon}
                alt="more"
            ...
            <div className="  flex justify-between items-center pt-[12px] pb-[12px]">
              <span className="text-[18px] font-medium leading-[26px] text-[#5c5c5c]">게시글</span>
              <Image
                src={rightIcon}
                alt="more"
                className="w-[20px] h-[20px] cursor-pointer"
            ...
            <div className="  flex justify-between items-center pt-[12px] pb-[12px]">
              <span className="text-[18px] font-medium leading-[26px] text-[#5c5c5c]">댓글</span>
              <Image
                src={rightIcon}
                alt="more"
                className="w-[20px] h-[20px] cursor-pointer"
