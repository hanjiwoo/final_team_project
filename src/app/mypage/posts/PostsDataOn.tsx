...
export default function PostsDataOn() {
	return (
		<div className="flex justify-center items-center w-screen mt-[60px] mb-[60px]">
			<div className="w-[880px]">
				...
				<form className="w-full flex flex-col justify-center items-left">
					...
					<h2 className="text-[16px] font-semibold leading-[24px] text-[#212121] mb-[8px]">
						게시글 제목
					</h2>
					<div className="text-[14px] text-[#5C5C5C] font-[500] mb-[16px]">
						전국의 착한 가격 맛집 모-음 웹 사이트 운영이 시작되었습니다 <br />
						해당 글은 커뮤니티 게시글입니다
					</div>
					<div className="text-[12px] font-[500] leading-[18px] text-[#999]">
						2024.01.01
					</div>
				</form>
